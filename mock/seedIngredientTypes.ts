...
const seedIngredientTypes = [
  ...
  { _id: new Types.ObjectId('6264264220403a1e86e3ab48'), name: 'อาหารแปรรูป' },
  { _id: new Types.ObjectId('62642648a293bd52a72832e0'), name: 'ไข่และผลิตภัณฑ์จากนม' },
  { _id: new Types.ObjectId('6264264d1e6c93c6d70d63cc'), name: 'ผลิตภัณฑ์จากแป้ง' },
