...
export default [
  {
    ...
    nutritionalDetail: {
      ...
      totalNutrients: {
        ...
        FAT: { label: 'Total lipid (fat)', quantity: 0.28, unit: 'g' },
        FASAT: { label: 'Fatty acids, total saturated', quantity: 0.077, unit: 'g' },
        FAMS: { label: 'Fatty acids, total monounsaturated', quantity: 0.088, unit: 'g' },
        FAPU: { label: 'Fatty acids, total polyunsaturated', quantity: 0.076, unit: 'g' },
        CHOCDF: { label: 'Carbohydrate, by difference', quantity: 28.17, unit: 'g' },
        FIBTG: { label: 'Fiber, total dietary', quantity: 0.4, unit: 'g' },
        SUGAR: { label: 'Sugars, total', quantity: 0.05, unit: 'g' },
        PROCNT: { label: 'Protein', quantity: 2.69, unit: 'g' },
        CHOLE: { label: 'Cholesterol', quantity: 0, unit: 'mg' },
        NA: { label: 'Sodium, Na', quantity: 1, unit: 'mg' },
      },
      totalDaily: {
        ENERC_KCAL: { label: 'Energy', quantity: 6.5, unit: '%' },
        FAT: { label: 'Fat', quantity: 0.43076923076923085, unit: '%' },
        FASAT: { label: 'Saturated', quantity: 0.385, unit: '%' },
        CHOCDF: { label: 'Carbs', quantity: 9.39, unit: '%' },
        FIBTG: { label: 'Fiber', quantity: 1.6, unit: '%' },
        PROCNT: { label: 'Protein', quantity: 5.38, unit: '%' },
        ...
        K: { label: 'Potassium', quantity: 0.7446808510638298, unit: '%' },
        FE: { label: 'Iron', quantity: 6.666666666666667, unit: '%' },
        ZN: { label: 'Zinc', quantity: 4.454545454545454, unit: '%' },
        P: { label: 'Phosphorus', quantity: 6.142857142857143, unit: '%' },
        VITA_RAE: { label: 'Vitamin A', quantity: 0, unit: '%' },
        VITC: { label: 'Vitamin C', quantity: 0, unit: '%' },
        THIA: { label: 'Thiamin (B1)', quantity: 13.583333333333334, unit: '%' },
        RIBF: { label: 'Riboflavin (B2)', quantity: 1, unit: '%' },
        NIA: { label: 'Niacin (B3)', quantity: 9.225, unit: '%' },
      ...
      totalNutrientsKCal: {
        ...
        CHOCDF_KCAL: { label: 'Calories from carbohydrates', quantity: 116, unit: 'kcal' },
      },
    },
  },
  {
    ...
    nutritionalDetail: {
      ...
      totalWeight: 100,
      totalNutrients: {
        ENERC_KCAL: { label: 'Energy', quantity: 154.99647564458854, unit: 'kcal' },
        FAT: { label: 'Total lipid (fat)', quantity: 3.622937405208318, unit: 'g' },
        FASAT: { label: 'Fatty acids, total saturated', quantity: 1.5398411922781396, unit: 'g' },
        FATRN: { label: 'Fatty acids, total trans', quantity: 0.009610305025915172, unit: 'g' },
        FAMS: { label: 'Fatty acids, total monounsaturated', quantity: 1.1486479194934234, unit: 'g' },
        FAPU: { label: 'Fatty acids, total polyunsaturated', quantity: 0.6336089997365097, unit: 'g' },
        CHOCDF: { label: 'Carbohydrate, by difference', quantity: 25.444349432019113, unit: 'g' },
        FIBTG: { label: 'Fiber, total dietary', quantity: 0.29183011678966647, unit: 'g' },
        SUGAR: { label: 'Sugars, total', quantity: 2.6359520987437532, unit: 'g' },
        PROCNT: { label: 'Protein', quantity: 4.714318085772707, unit: 'g' },
        CHOLE: { label: 'Cholesterol', quantity: 9.797749577692729, unit: 'mg' },
        NA: { label: 'Sodium, Na', quantity: 176.24915278866632, unit: 'mg' },
      },
      totalDaily: {
        ENERC_KCAL: { label: 'Energy', quantity: 7.749823782229427, unit: '%' },
        FAT: { label: 'Fat', quantity: 5.573749854166643, unit: '%' },
        FASAT: { label: 'Saturated', quantity: 7.699205961390699, unit: '%' },
        CHOCDF: { label: 'Carbs', quantity: 8.481449810673038, unit: '%' },
        FIBTG: { label: 'Fiber', quantity: 1.1673204671586659, unit: '%' },
        PROCNT: { label: 'Protein', quantity: 9.428636171545413, unit: '%' },
        CHOLE: { label: 'Cholesterol', quantity: 3.2659165258975764, unit: '%' },
        NA: { label: 'Sodium', quantity: 7.343714699527763, unit: '%' },
        CA: { label: 'Calcium', quantity: 3.062237960008853, unit: '%' },
        MG: { label: 'Magnesium', quantity: 4.653082332599421, unit: '%' },
        K: { label: 'Potassium', quantity: 2.113219666164491, unit: '%' },
        FE: { label: 'Iron', quantity: 3.5925938306464187, unit: '%' },
        ZN: { label: 'Zinc', quantity: 5.666037944126057, unit: '%' },
        P: { label: 'Phosphorus', quantity: 10.088767463245869, unit: '%' },
        VITA_RAE: { label: 'Vitamin A', quantity: 0.9785417000306987, unit: '%' },
        VITC: { label: 'Vitamin C', quantity: 2.3193897843572486, unit: '%' },
        THIA: { label: 'Thiamin (B1)', quantity: 4.190377575533379, unit: '%' },
        RIBF: { label: 'Riboflavin (B2)', quantity: 3.8064480225900876, unit: '%' },
        NIA: { label: 'Niacin (B3)', quantity: 7.414949832195671, unit: '%' },
        VITB6A: { label: 'Vitamin B6', quantity: 7.207134043462099, unit: '%' },
        FOLDFE: { label: 'Folate equivalent (total)', quantity: 2.835894598897683, unit: '%' },
        VITB12: { label: 'Vitamin B12', quantity: 3.498765865760576, unit: '%' },
        VITD: { label: 'Vitamin D', quantity: 0.7332632120504898, unit: '%' },
        TOCPHA: { label: 'Vitamin E', quantity: 0.9469322410276485, unit: '%' },
        VITK1: { label: 'Vitamin K', quantity: 1.4989926387314185, unit: '%' },
      },
      totalNutrientsKCal: {
        ENERC_KCAL: { label: 'Energy', quantity: 155, unit: 'kcal' },
        PROCNT_KCAL: { label: 'Calories from protein', quantity: 19, unit: 'kcal' },
        FAT_KCAL: { label: 'Calories from fat', quantity: 33, unit: 'kcal' },
        CHOCDF_KCAL: { label: 'Calories from carbohydrates', quantity: 103, unit: 'kcal' },
      },
    },
  },
  {
